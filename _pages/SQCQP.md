...
Package - <a style="font-size: 16px; font-weight: bold;color:#006DB0" href="\files\SQCQP-Matlab.zip" target="_blank">SQCQPpack-Matlab</a> and <a style="font-size: 16px; font-weight: bold;color:#006DB0" href="\files\SQCQP-Python.zip" target="_blank">SQCQPpack-Python</a> (click to download) provides 1 solver from the following paper:</div>
