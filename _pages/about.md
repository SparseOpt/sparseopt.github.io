...
<b>SparseOpt</b> is a specialized computational platform for sparse and step optimization. The current release provides the following solvers, each available in Matlab and Python implementations, to support various related optimization applications.
</div>
